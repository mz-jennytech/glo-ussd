 ...
 */
public class AirtimeDirectHandler implements ShortCodeInterface {

    private final Logger LOG = Logger.getLogger(AirtimeDirectHandler.class);
    private String actionName = "Airtime-Direct-Self";
    ...
    public String process(Data data) {
        ...
        if (session == null) {
            ...
            String[] msgLength = session.getQueue().get(0).split("\\*");// *805*<AMOUNT>#
...
//                        if (verifyAccountA) {
                                        ...
                                        String resp = doDirectVTUProcessing(session, ums.getBankCode(), ums.getAccountNo(), amount, initialDial1, 0.0, "");
                                        sb.append(resp);
                                        instance.destroySession(session.getSessionId());
//                        } else {
...
//                                    session.getSessionData().put("maxAcctSize", counter);
            ...
            if (session.getSessionData().get("process") != null && session.getSessionData().get("processA") == null) {
                String actionName = "Airtime-Direct-Self";
...
//                            }
                ...
                if (userAccounts == null || userAccounts.isEmpty()) {
                    ...
                    if (verifyAccountA) {
                        ...
                        String resp = doDirectVTUProcessing(session, bankCode1, acctNum1, amount, initialDial1, 0.0, "");
                        sb.append(resp);
                        instance.destroySession(session.getSessionId());
                    } else {
                        sb.append("This mobile number is NOT tied to your bank account! ~ Please contact your bank for assistance.~ Thank you.").append("~");
...
//                }
     ...
     * //****************************************************************************************************************
     */
    private String doDirectVTUProcessing(USSDSession session, String bankCode, String accountNo, String amount, String initialDial, double rate, String ussdPin) {
        System.out.println("doDirectVTUProcessing Details of doProcessing....");
        System.out.println("doDirectVTUProcessing MSISDN : " + session.getMsisdn());
        System.out.println("doDirectVTUProcessing Account Number : " + accountNo);
        System.out.println("doDirectVTUProcessing Bank Code : " + bankCode);
        System.out.println("doDirectVTUProcessing appCode : " + appCode);
        System.out.println("doDirectVTUProcessing Amount : " + amount);
        System.out.println("doDirectVTUProcessing Initial Dial : " + initialDial);
        LOG.info("doDirectVTUProcessing Calling doProcessing!!!!");
        ...
        System.out.println("doDirectVTUProcessing appId : " + appId);
            ...
            try {
                switch (xResponse.getResponse()) {
                    case 0:
                        ...
                        String merchantCode = "JT_" + bankCode + "_"+appId;
