 ...
 */
public class DataSelfHandler implements ShortCodeInterface {

    private final Logger LOG = Logger.getLogger(DataSelfHandler.class);
    private String actionName = "Data-Self";
    ...
    public String process(Data data) {
        ...
        if (session == null) {
            ...
            String[] msgLength = session.getQueue().get(0).split("\\*");// *389*805*1*<AMOUNT>*805#
...
//                                    if (verifyAccountA) {
                                                    ...
                                                    String resp = doMenubasedDATAProcessing(session, ums.getBankCode(), ums.getAccountNo(), String.valueOf(jsn.get("amount")), initialDial, String.valueOf(jsn.get("productID")), 0.0, "");
                                                    sb.append(resp);
                                                    instance.destroySession(session.getSessionId());
...
//                            if (verifyAccountA) {
                                String initialDial = "1";//session.getQueue().get(1);
                                String resp3 = doMenubasedDATAProcessing(session, ums.getBankCode(), ums.getAccountNo(), String.valueOf(jsn.get("amount")), initialDial, String.valueOf(jsn.get("productID")), 0.0, "");
                                sb.append(resp3);
                                instance.destroySession(session.getSessionId());
//                            } else {
//                                sb.append("This mobile number is NOT tied to your bank account! ~ Please contact your bank for assistance.~ Thank you.").append("~");
...
//                            }
                ...
                if (userAccounts == null || userAccounts.isEmpty()) {
                    ...
                    int acctIndexu = (Integer) session.getSessionData().get("DATA_SELF_DIRECT-BANKSELECT-NEWUSER-accountNumberIndex");
                    LOG.info(data.getSessionId() + " DATA_SELF_DIRECT-BANKSELECT-NEWUSER-accountNumberIndex ::::::::::::::::::::::::::::::::::::::::::::::" + acctIndexu);
                    String nuban = session.getQueue().get(acctIndexu);
                    ...
                    if (verifyAccount) {
                        ...
                        if (service.findSubscriberByMobileAccount(data.getMsisdn(), nuban, appCode) == null) {
                           ...
                           // subscriber.setAppcode(appCode);
                            ...
                            String resp = doMenubasedDATAProcessing(session, bank_Code, nuban, String.valueOf(jsn1.get("amount")), initialDial, String.valueOf(jsn1.get("productID")), 0.0, "");
                            sb.append(resp);
                            instance.destroySession(session.getSessionId());
...
//                }
     ...
     * //****************************************************************************************************************
     */
    private String doMenubasedDATAProcessing(USSDSession session, String bankCode, String accountNo, String amount, String initialDial, String productID, double rate, String ussdPin) {
        System.out.println("doMenubasedDATAProcessing Details of doProcessing....");
        System.out.println("doMenubasedDATAProcessing MSISDN : " + session.getMsisdn());
        System.out.println("doMenubasedDATAProcessing Account Number : " + accountNo);
        System.out.println("doMenubasedDATAProcessing Bank Code : " + bankCode);
        System.out.println("doMenubasedDATAProcessing Amount : " + amount);
        System.out.println("doMenubasedDATAProcessing ProductID : " + productID);
        System.out.println("doMenubasedDATAProcessing Initial Dial : " + initialDial);
        LOG.info("doMenubasedDATAProcessing Calling doProcessing!!!!");
        ...
        System.out.println("doMenubasedDATAProcessing appId : " + appId);
