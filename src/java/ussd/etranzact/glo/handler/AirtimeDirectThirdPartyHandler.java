 ...
 */
public class AirtimeDirectThirdPartyHandler implements ShortCodeInterface {

    private final Logger LOG = Logger.getLogger(AirtimeDirectThirdPartyHandler.class);
    private String actionName = "Airtime-Direct-Third_Party";
    ...
    public String process(Data data) {
        ...
        if (session == null) {
            ...
            String[] msgLength = session.getQueue().get(0).split("\\*");// *805*<Amount>*msisdn#
...
//                                    if (verifyAccount) {
                                    if (service.verifyUserPIN(data.getMsisdn(), subscriber.getAccountNo(), subscriber.getBankCode(), userPin, appCode)) {
                                        ...
                                        String resp = doDirect3rdPartyVTUProcessing(session, subscriber.getBankCode(), subscriber.getAccountNo(), mobile3rdParty, amount, initialDial, 0.0, userPin);
                                        sb.append(resp);
                                        instance.destroySession(session.getSessionId());
                    ...
                    if (session.getSessionData().get("pinn1") == null) {
                        ...
                        if (pinn1.equals(pinn2)) {
                            ...
                            if (verifyAccountA) {
                                ...
                                String initialDial = session.getQueue().get(0);
                                String resp = doDirect3rdPartyVTUProcessing(session, bankCode, accountNo, mobile3rdParty, amount, initialDial, 0.0, pinn1);
                                sb.append(resp);
                                instance.destroySession(session.getSessionId());
                            } else {
                                sb.append("This mobile number is NOT tied to your bank account! ~ Please contact your bank for assistance.~ Thank you.").append("~");
...
//                            if (verifyAccountA) {
                            if (service.verifyUserPIN(data.getMsisdn(), ums.getAccountNo(), userPin, appCode)) {
                                ...
                                String resp = doDirect3rdPartyVTUProcessing(session, ums.getBankCode(), ums.getAccountNo(), mobile3rdParty, amount, initialDial, 0.0, userPin);
                                sb.append(resp);
                                instance.destroySession(session.getSessionId());
                            } else {
...
//                            }
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    private String doDirect3rdPartyVTUProcessing(USSDSession session, String bankCode, String accountNo, String phone2, String amount, String initialDial, double rate, String ussdPin) {
        phone2 = phone2.replaceAll(" ", "");
        if (phone2.startsWith("0")) {
            phone2 = "234" + phone2.substring(1);
        }

        System.out.println("doDirect3rdPartyVTUProcessing Details of doProcessing....");
        System.out.println("doDirect3rdPartyVTUProcessing MSISDN : " + session.getMsisdn());
        System.out.println("doDirect3rdPartyVTUProcessing 3rd Party MSISDN : " + phone2);
        System.out.println("doDirect3rdPartyVTUProcessing Account Number : " + accountNo);
        System.out.println("doDirect3rdPartyVTUProcessing Bank Code : " + bankCode);
        System.out.println("doDirect3rdPartyVTUProcessing appCode : " + appCode);
        System.out.println("doDirect3rdPartyVTUProcessing Amount : " + amount);
        System.out.println("doDirect3rdPartyVTUProcessing Initial Dial : " + initialDial);
        LOG.info("doDirect3rdPartyVTUProcessing Calling doProcessing!!!!");
        ...
        String actionName = "AIRTIME-DIRECT-THIRD PARTY";
        String appId = "" ;
        ...
        System.out.println("doDirect3rdPartyVTUProcessing appId : " + appId);
